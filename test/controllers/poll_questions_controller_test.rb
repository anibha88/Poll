...
class PollQuestionsControllerTest < ActionController::TestCase
  ...
  test "should create poll_question" do
    assert_difference('PollQuestion.count') do
      post :create, poll_question: { end_time: @poll_question.end_time, start_time: @poll_question.start_time, text: @poll_question.text }
    end
  ...
  test "should update poll_question" do
    patch :update, id: @poll_question, poll_question: { end_time: @poll_question.end_time, start_time: @poll_question.start_time, text: @poll_question.text }
    assert_redirected_to poll_question_path(assigns(:poll_question))
  end
